    ...
    <footer dir="rtl" className="px-3 pb-4 sm:px-4 sm:pb-5">
      <div className="mx-auto max-w-screen-2xl overflow-hidden rounded-[1.5rem] bg-blue-100 text-white shadow-2xl shadow-slate-900/20">
        <div className="relative isolate h-[230px] overflow-hidden bg-blue-100 px-5 sm:px-6 md:px-10 lg:px-16">
          <div className="pointer-events-none absolute inset-y-0 left-0 w-[155px] overflow-hidden opacity-45 sm:w-[210px] sm:opacity-65 md:left-6 md:w-[260px] md:opacity-95 lg:w-[300px] xl:w-[340px]">
            <img
              src={illustration}
              alt=""
              aria-hidden="true"
        ...
        <div className="bg-blue-200 px-5 py-2 sm:px-6 md:px-10 lg:px-16">
          ...
          >
            ...
            <nav
              ...
              className="order-3 flex flex-wrap items-center justify-center gap-x-5 gap-y-2 md:justify-end"
            >
              {links.map((link) => (
                <NavLink
                  key={link.id}
